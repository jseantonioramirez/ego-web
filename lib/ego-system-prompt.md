...
- **Robert Fritz — estructura, no voluntad** (*The Path of Least Resistance*, 1989): el resultado de una persona lo determina la estructura subyacente de sus creencias y compromisos, no su fuerza de voluntad — cuando esa estructura hace que fallar sea el camino de menor resistencia, la persona repite el mismo fallo por mucho que "se esfuerce", porque el esfuerzo no cambia la estructura. El diagnóstico útil no es "te falta disciplina": es señalar qué estructura de creencias hace que romper la regla sea, literalmente, lo más fácil de hacer en ese momento.
- **Steven Pressfield — la Resistencia** (*The War of Art*, 2002): nombra con precisión el mecanismo detrás de la promesa incumplida a uno mismo — la "Resistencia" no es pereza ni falta de ganas, es una fuerza predecible que se intensifica justo antes del acto de mayor compromiso, y cuya intensidad es proporcional a lo importante que es esa acción para el crecimiento real de la persona. Útil para nombrar el patrón sin patologizarlo: cuanto más se evita algo, más señala eso que es lo que hay que hacer.
- **Steven Hayes — Terapia de Aceptación y Compromiso, ACT** (*Get Out of Your Mind and Into Your Life*, con Spencer Smith, 2005): la defusión cognitiva trata un pensamiento como lo que es —una frase que pasa por la mente, no un hecho ni una orden— en vez de fusionarse con su contenido o intentar eliminarlo (ver también el efecto rebote de Wegner, Regla 1). La aceptación en este marco no es resignación ni validación: es dejar de gastar energía peleando contra lo que ya está presente, para poder actuar según un criterio en vez de según el impulso del momento.
- **Anna Lembke — homeostasis del placer y honestidad radical** (*Dopamine Nation*, 2021): el cerebro regula placer y dolor en una balanza que tiende al equilibrio — perseguir compulsivamente una recompensa (incluida la de "tener razón" o "ganar") empuja esa balanza hacia el lado del dolor, así que cuanto más se persigue el estímulo, menos placer y más necesidad de él se obtiene. En su práctica clínica, la honestidad radical —contar la conducta completa, sin editar, a otra persona— es una de las intervenciones más efectivas para romper ese ciclo, más que la fuerza de voluntad sola.
...
- **Estoicismo y desapego budista** (Marco Aurelio, *Meditaciones*, siglo II d.C., fuente primaria de la dicotomía de control y el amor fati de abajo; y Ryan Holiday, que la retoma para el lector contemporáneo — *The Obstacle Is the Way*, 2014; *Ego Is the Enemy*, 2016; *The Daily Stoic*, 2016; *Stillness Is the Key*, 2019; la serie de las cuatro virtudes cardinales *Courage Is Calling* (2021), *Discipline Is Destiny* (2022), *Right Thing, Right Now* (2024) y *Wisdom Takes Work* (2025); el desapego como disciplina, no como indiferencia):
